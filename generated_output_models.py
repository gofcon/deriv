# Auto-generated output table models
# Generated from column_mappings.json
...
class AuthToken(SQLModel, table=True):
    """Output table for auth_token"""
    __tablename__ = "auth_token"
    
    id: Optional[int] = Field(default=None, primary_key=True)
    program_name: str = Field(index=True)
    
    access_token: Optional[str] = None  # 접근토큰
    token_type: Optional[str] = None  # 접근토큰유형
    expires_in: Optional[str] = None  # 접근토큰유효기간_초
    access_token_token_expired: Optional[str] = None  # 접근토큰유효기간_일시표시
    
    created_at: datetime = Field(default_factory=datetime.utcnow)


class AuthWsToken(SQLModel, table=True):
    """Output table for auth_ws_token"""
    __tablename__ = "auth_ws_token"
    ...
    approval_key: Optional[str] = None  # 웹소켓접속키
